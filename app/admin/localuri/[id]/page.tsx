  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Editează localul</h1>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 space-y-5">
        ...
        <div className="flex flex-col gap-1">
          <label className="font-medium text-gray-700">Nume *</label>
          <input
            type="text" value={name} onChange={(e) => setName(e.target.value)} maxLength={200}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} maxLength={50}
              className="border border-gray-300 rounded-lg px-4 py-3 text-base focus:outline-none focus:border-[#c84b1e]"
            />
          </div>
        </div>
