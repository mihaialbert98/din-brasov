...
export async function POST(req: Request) {
  ...
  const items = await db.select({ id: experiences.id, imageUrl: experiences.imageUrl, title: experiences.title })
  ...
  await db.delete(experiences).where(inArray(experiences.id, ids));
